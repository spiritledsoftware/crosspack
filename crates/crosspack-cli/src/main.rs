...
use crosspack_installer::{
    append_transaction_journal_entry, apply_integration_plan_with_fs, bin_path,
    clear_active_transaction, current_unix_timestamp, default_user_prefix,
    disable_integration_plan_with_fs, expose_binary, expose_completion, expose_gui_app,
    expose_integrations, exposed_completion_path, gui_asset_path, install_from_artifact_to_dir,
    ...
    projected_gui_assets, projected_integrations, read_active_transaction_marker,
    ...
    read_integration_activation_state, read_integration_state, read_transaction_metadata,
    register_native_gui_app_best_effort, remove_exposed_binary, remove_exposed_completion,
    remove_exposed_gui_asset, remove_exposed_integration, remove_file_if_exists,
    remove_native_gui_registration_best_effort, replay_activation_rollback_entry_with_fs,
    resolve_installed_package_selector, run_package_native_uninstall_actions,
    run_service_action_plan,
