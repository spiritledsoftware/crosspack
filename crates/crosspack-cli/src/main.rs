...
mod tests {
    use super::{
        ...
        render_transaction_preview_lines, resolve_transaction_snapshot_id, run_repair_command,
        ...
        Cli, CliRegistryKind, Commands, MetadataBackend, PlannedPackageChange, PlannedRemoval,
