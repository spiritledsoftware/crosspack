...
use crosspack_installer::{
    ...
    expose_gui_app, expose_integrations_for_host_platform, expose_shell_init,
    ...
    read_identity_integration_state, read_identity_shell_init_state, read_install_receipts,
    read_integration_activation_state, read_integration_state, read_shell_init_state,
    ...
    remove_exposed_shell_init, remove_file_if_exists, remove_native_gui_registration_best_effort,
    ...
    write_identity_shell_init_state, write_install_receipt, write_installed_package_state,
    write_integration_activation_state, write_integration_state, write_pin, write_shell_init_state,
    ActivationAdapterOutcome, ActivationFilesystem, ActivationFsEntry, ActivationOwner,
    ActivationRollbackEntry, ActivationRollbackOperation, ActiveTransactionMarker,
    ArtifactInstallOptions, GuiExposureAsset, GuiNativeRegistrationRecord, HostActivationContext,
    HostPlatform, InstallInteractionPolicy, InstallMode, InstallReason, InstallReceipt,
    InstalledPackageIdentity, InstalledPackageSelector, InstalledPackageState,
    ...
    RealActivationFs, ServiceActivationMetadata, ShellInitProjection,
    SystemActivationCommandExecutor, TransactionCoordinator, TransactionJournalEntry,
